...
from infogan.misc.datasets import SVHNDataset
...
c2_svhn_image_size = 32


# In[5]:

dataset = SVHNDataset()  # The full dataset is enormous (202,599 frames).
...
model = RegularizedGAN(
    ...
    latent_spec=c2_svhn_latent_spec,  # Trying with the above celebA latent_spec.
